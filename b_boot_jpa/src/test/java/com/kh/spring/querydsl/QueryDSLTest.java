...
public class QueryDSLTest {
	...
	@Test
	@DisplayName("대출자 아이디가 test인 모든 대출건의 제목과 대출번호를 조회")
	public void innerJoinProjections() {
		queryDSLRepository.innerJoinProjections("test").forEach(e -> log.info(e.toString()));
	}
	
	@Test
	@DisplayName("대출자 아이디가 test인 모든 대출건의 제목과 대출번호를 조회")
	public void tuple() {
		queryDSLRepository.tuple("test").forEach(e -> log.info(e.toString())); //혹은 e.get(0,String.class)
	}
	...
	@Test
	@DisplayName("도서 재고 수량을 기준으로 내림차순")
	public void orderBy() {
