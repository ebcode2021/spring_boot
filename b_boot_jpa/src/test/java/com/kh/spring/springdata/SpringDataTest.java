...
public class SpringDataTest {
   ...
   public void test01() {
      springDataRepository.findByCategoryContainingAndBookAmtGreaterThanEqualAndTitleStartingWith("문학", 3, "디")
      .forEach(e -> log.info(e.toString()));
   }
   
   @Test
   @DisplayName("도서 재고가 3권 이상이면서 도서명이 디로 시작하는 도서를 조회")
   public void test02() {
      springDataRepository.findByBookAmtGreaterThanEqualAndTitleStartingWith(3, "디")
      .forEach(e -> log.info(e.toString()));
   }
